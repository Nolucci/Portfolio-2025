...
function NavBar() {
  ...
  return (
      ...
      >
        <Container>
          <Navbar.Brand href="/" className="d-flex" style={{ fontFamily: 'Espace', fontSize: '45px', fontWeight: 'bold', textDecoration: 'none', color: 'inherit' }}>
            NF
          </Navbar.Brand>
          <Navbar.Toggle
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="ms-auto" defaultActiveKey="#home">
              ...
              <Nav.Item>
                ...
                >
                  <AiOutlineUser style={{ marginBottom: "2px" }} /> Infos
                </Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link
